...
#i deleted my addresses and stuff, hopefully it is still readable
...
#timne for the hard part baby!! :D
files = []
def importFiles(curFileName):
    files.append(__import__(curFileName))

if __name__ == '__main__':
    with ThreadPoolExecutor(max_workers=13) as executor: #change this to number of workers
